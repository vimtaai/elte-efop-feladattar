...
function handleCardInput() {
  ...
  if (len > 25) {
    card.value = card.value.slice(0, 25);
  }
  if (len > 0) {
    if (cardNumber.value[0] === "5") {
      cardType.innerHTML = mastercard + "MasterCard";
    } else if (cardNumber.value[0] === "4") {
      cardType.innerHTML = visa + "Visa";
    } else {
      cardType.innerHTML = "Invalid card";
    }
  } else {
    cardType.innerHTML = "";
  }
